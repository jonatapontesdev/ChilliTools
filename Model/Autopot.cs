...
namespace JPRagTools.Model
{
    ...
    public class Autopot : Action
    {
        ...
        public void Start()
        {
            ...
            {
                int hpPotCount = 0;
                this.thread = new _JPThread(_ => AutopotThreadExecution(roClient, hpPotCount));
        ...
        private void pot(Key key)
        {
            ...
            if ((k != Keys.None) && !KeyboardHelper.IsKeyDown(Key.LeftAlt) && !KeyboardHelper.IsKeyDown(Key.RightAlt))
            {

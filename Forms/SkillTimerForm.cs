    ...
    public partial class SkillTimerForm : Form, IObserver
    {
        ...
        private void txthDelay1TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show($"[SkillTimer] {ex.Message}", "Por favor, compartilhe esta captura de tela no discord do ChilliTools.", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void txthDelay3TextChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"[SkillTimer] Error Message: {ex.Message}", "Por favor, compartilhe esta captura de tela no discord do ChilliTools.", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
    }
}